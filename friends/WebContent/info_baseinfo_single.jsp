...
<head>
    ...
    <link rel="stylesheet" href="css/info_baseinfo_single.css">
            ...
            <div class="col-9" id="rightSide">
                <div class="row">
                    ...
                    <div class="col-11" id="rightSidebody">
                        ...
                        <!-- 资料主体 -->
                        <form method="post" action="${pageContext.request.contextPath }/singleServlet">
                        <div id="baseinfo_single" style="padding: 30px 30px 0px 30px;">
                            
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                                        <label class="input-group-text" for="inputGroupSelect01" style="padding-left:44px;">性别：</label>
                                    </div>
                                    <select class="custom-select" id="inputGroupSelect01" name="other_sex" value="${User.other_sex }">
                                        <option selected>${User.other_sex }</option>
                                ...
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                                        <label class="input-group-text" for="inputGroupSelect01" style="padding-left:44px;">年龄：</label>
                                    </div>
                                    <select class="custom-select" id="inputGroupSelect01" name="other_age" value="${User.other_age }">
                                        <option selected>${User.other_age }</option>
                                    ...
                                    <select class="custom-select" id="inputGroupSelect01" name="other_age2" value="${User.other_age2 }">
                                        <option selected>${User.other_age2 }</option>
											<option value="18">18</option>
											<option value="19">19</option>
											<option value="20">20</option>
											<option value="21">21</option>
                                ...
                                <div class="row form-group" style="padding-left:15px;padding-right:15px;">
                                    <div class="input-group mb-3">
                                        <div class="input-group-prepend">
                                            <label class="input-group-text" for="inputGroupSelect01">工作地区：</label>
                                        </div>
                                        <select id="s_province" class="custom-select" name="other_s_province" value="${User.other_s_province }">${User.other_s_province }</select>
                                        <select id="s_city" class="custom-select" name="other_s_city" value="${User.other_s_city }">${User.other_s_city }</select>
                                        <select id="s_county" class="custom-select" name="other_s_county" value="${User.other_s_county }">${User.other_s_county }</select>
										...
										<script class="resources library" type="text/javascript">
													...
													*/
													...
													var opt0 = ["${User.other_s_province }","${User.other_s_city }","${User.other_s_county }"];//初始值
                                ...
                                <div class="input-group mb-3" style="margin-top:-16px;">
                                    <div class="input-group-prepend">
                                        <label class="input-group-text" for="inputGroupSelect01">婚姻状况：</label>
                                    </div>
                                    <select class="custom-select" id="inputGroupSelect01" name="other_marital" value="${User.other_marital }">
                                        <option selected>${User.other_marital }</option>
                                ...
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                                        <label class="input-group-text" for="inputGroupSelect01" style="padding-left:44px;">学历：</label>
                                    </div>
                                    <select class="custom-select" id="inputGroupSelect01" name="other_education" value="${User.other_education }">
                                        <option selected>${User.other_education }</option>
                                        <option value="不限">不限</option>
                                ...
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                                        <label class="input-group-text" for="inputGroupSelect01" style="padding-left:28px;">月收入：</label>
                                    </div>
                                    <select class="custom-select" id="inputGroupSelect01" name="other_salary" value="${User.other_salary }">
                                        <option selected>${User.other_salary }</option>
                                ...
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                                        <label class="input-group-text" for="inputGroupSelect01">有无孩子：</label>
                                    </div>
                                    <select class="custom-select" id="inputGroupSelect01" name="other_children" value="${User.other_children }">
                                        <option selected>${User.other_children }</option>
											<option value="没有">没有</option>
											<option value="有，我们住在一起">有，我们住在一起</option>
											<option value="有，我们偶尔一起住">有，我们偶尔一起住</option>
											<option value="有，但不在身边">有，但不在身边</option>
                                    </select>
                                </div>
                                ...
                                <div id="baseInfoButton">
									...
									<a href="${pageContext.request.contextPath }/TOinner" id="baseInfoButtonA2" class="btn btn-outline-danger" role="button" aria-disabled="true">跳过</a>
								</div>
