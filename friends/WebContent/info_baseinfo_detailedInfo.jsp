...
<link rel="stylesheet" href="css/info_baseinfo_detailedInfo.css">
			...
			<div class="col-9" id="rightSide">
				<div class="row">
					...
					<div class="col-11" id="rightSidebody">
						...
						<!-- 资料主体 -->
						<form method="post" action="${pageContext.request.contextPath }/detailedInfoServlet">
							<div id="baseinfo_regInfo" style="padding: 30px 30px 0px 30px;">
								...
								<div class="row form-group">
									<div class="input-group mb-3">
										...
										<input type="text" class="form-control" aria-label="Default"
											aria-describedby="inputGroup-sizing-default" name="realName" value="${User.realName }">
									</div>
								</div>
									...
									<div class="input-group mb-3">
										<div class="input-group-prepend">
											<label class="input-group-text" for="inputGroupSelect01"
												style="padding-left: 44px;">籍贯：</label>
										</div>
										<select id="s_province" class="custom-select"
											name="o_province" value="${User.o_province }"></select> <select id="s_city"
											class="custom-select" name="o_city" value="${User.o_city }"></select> <select
											id="s_county" class="custom-select" name="o_county" value="${User.o_county }"></select>
										
<script class="resources library" type="text/javascript">
													/*
													*	全国三级城市联动 js版
													*/
													function Dsy(){
													...
													var opt0 = ["${User.o_province }","${User.o_city }","${User.o_county }"];//初始值
								...
								<div class="row form-group">
									<div class="input-group mb-3">
										<div class="input-group-prepend">
											<label class="input-group-text" for="inputGroupSelect01"
												style="padding-left: 44px;">体重：</label>
										</div>
										<select class="custom-select" id="inputGroupSelect01" name="weight" value="${User.weight }">
											...
											<option value="130以上">130以上</option>
										</select> <span style="padding: 5px;">公斤(kg)</span>
									</div>
								</div>
								...
								<div class="row form-group">
									<div class="input-group mb-3">
										<div class="input-group-prepend">
											<label class="input-group-text" for="inputGroupSelect01"
												style="padding-left: 44px;">生肖：</label>
										</div>
										<select class="custom-select" id="inputGroupSelect01" name="zodiac" value="${User.zodiac }">
											<option selected>${User.zodiac }</option>
								...
								<div class="row form-group">
									<div class="input-group mb-3">
										<div class="input-group-prepend">
											<label class="input-group-text" for="inputGroupSelect01"
												style="padding-left: 44px;">星座：</label>
										</div>
										<select class="custom-select" id="inputGroupSelect01" name="constellation" value="${User.constellation }">
											<option selected>${User.constellation }</option>
											<option value="白羊座(03.21-04.20)">白羊座(03.21-04.20)</option>
											<option value="金牛座(04.21-05.20)">金牛座(04.21-05.20)</option>
											<option value="双子座(05.21-06.21)">双子座(05.21-06.21)</option>
											<option value="巨蟹座(06.22-07.22)">巨蟹座(06.22-07.22)</option>
											<option value="狮子座(07.23-08.22)">狮子座(07.23-08.22)</option>
											<option value="处女座(08.23-09.22)">处女座(08.23-09.22)</option>
											<option value="天秤座(09.23-10.22)">天秤座(09.23-10.22)</option>
											<option value="天蝎座(10.23-11.21)">天蝎座(10.23-11.21)</option>
											<option value="射手座(11.22-12.21)">射手座(11.22-12.21)</option>
											<option value="摩羯座(12.22-01.19)">摩羯座(12.22-01.19)</option>
											<option value="水瓶座(01.20-02.19)">水瓶座(01.20-02.19)</option>
											<option value="双鱼座(02.20-03.20)">双鱼座(02.20-03.20)</option>
										</select>
									</div>
								</div>
								<div class="row form-group">
									<div class="input-group mb-3">
										<div class="input-group-prepend">
											<label class="input-group-text" for="inputGroupSelect01"
												style="padding-left: 44px;">血型：</label>
										</div>
										<select class="custom-select" id="inputGroupSelect01" name="bloodtype" value="${User.bloodtype }">
											<option selected>${User.bloodtype }</option>
								...
								<div class="row form-group">
									<div class="input-group mb-3">
										<div class="input-group-prepend">
											<label class="input-group-text" for="inputGroupSelect01"
												style="padding-left: 44px;">民族：</label>
										</div>
										<select class="custom-select" id="inputGroupSelect01" name="nation" value="${User.nation }">
											<option selected>${User.nation }</option>
								...
								<div class="row form-group">
									<div class="input-group mb-3">
										<div class="input-group-prepend">
											<label class="input-group-text" for="inputGroupSelect01"
												style="padding-left: 44px;">信仰：</label>
										</div>
										<select class="custom-select" id="inputGroupSelect01" name="faith" value="${User.faith }">
											<option selected>${User.faith }</option>
											...
											<option value="儒家门徒">儒家门徒</option>
											<option value="不可知论者">不可知论者</option>
								...
								<div id="baseInfoButton">
									...
									<a href="${pageContext.request.contextPath }/TOlifeInfo" id="baseInfoButtonA2" class="btn btn-outline-danger" role="button" aria-disabled="true">跳过</a>
								</div>
