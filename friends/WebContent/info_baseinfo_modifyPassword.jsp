...
<head>
    ...
    <link rel="stylesheet" href="css/info_baseinfo_modifyPassword.css">
            ...
            <div class="col-9" id="rightSide">
                <div class="row">
                    ...
                    <div class="col-11" id="rightSidebody">
                        ...
                        <!-- 资料主体 -->
                        <form method="post" action="${pageContext.request.contextPath }/modifyPasswordServlet">
                       		<div id="baseinfo_regInfo" style="padding: 100px 30px 0px 30px;">
	                         	<br>
                                ...
                                <div class="row form-group">
                                    <div class="input-group mb-3">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text" id="inputGroup-sizing-default" style="padding-left:44px;">旧密码：</span>
                                        </div>
                                        <input type="password" class="form-control" aria-label="Default" aria-describedby="inputGroup-sizing-default" name="oldPassword">
                                ...
                                <div class="row form-group">
                                    <div class="input-group mb-3">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text" id="inputGroup-sizing-default" style="padding-left:44px;">新密码：</span>
                                        </div>
                                        <input type="password" class="form-control" aria-label="Default" aria-describedby="inputGroup-sizing-default" name="newPassword">
                                    </div>
                                </div>
                                <div class="row form-group">
                                    <div class="input-group mb-3">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text" id="inputGroup-sizing-default" style="padding-left:44px;">确认密码</span>
                                        </div>
                                        <input type="password" class="form-control" aria-label="Default" aria-describedby="inputGroup-sizing-default" name="newPasswordConfirm">
								...
								<div id="baseInfoButton">
									<input type="submit" id="baseInfoButtonA1"
										class="btn btn-outline-danger" role="button"
										aria-disabled="true" style="width: 233px;" value="确认">
								</div>
