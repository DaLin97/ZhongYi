...
<link rel="stylesheet" href="css/info_baseinfo_regInfo.css">
				...
				<div class="row">
					...
					<div class="col-11" id="rightSidebody">
						...
						<div class="row" id="previewInfo">
							...
							<div class="col-3">
								<a href="${pageContext.request.contextPath}/Member_info?UUID=${User.uuid }" target=_blank>预览我的资料页</a>
								
							</div>
						</div>
						<!-- 资料主体 -->
						<form method="post" action="${pageContext.request.contextPath }/regInfoServlet">
							...
							<div id="baseinfo_regInfo" style="padding: 30px 30px 0px 30px;">
								...
								<div class="row form-group">
									<div class="input-group mb-3">
										<div class="input-group-prepend">
											<span class="input-group-text" style="padding-left: 44px;">昵称：</span>
										</div>
										
										<input type="text" class="form-control" aria-label="Default"
											aria-describedby="inputGroup-sizing-default" name="nickname" value="${User.nickname }">
								...
								<!-- <div class="row form-group">
									<div class="input-group mb-3">
										<div class="input-group-prepend">
											<span class="input-group-text" style="padding-left: 44px;">手机：</span>
										</div>
										<input type="text" class="form-control" aria-label="Default"
									...
									<div class="input-group mb-3">
										<div class="input-group-prepend">
											<label class="input-group-text" for="inputGroupSelect01"
												style="padding-left: 44px;">年龄： </label>
										</div>
										<select class="custom-select" name="age" value="${User.age }">
											<option selected>${User.age }</option>
										...
										</select> <span style="padding: 5px;">岁</span>
									</div>
								</div>
								<div class="row form-group">
									<div class="input-group mb-3">
										<div class="input-group-prepend">
											<label class="input-group-text" for="inputGroupSelect01"
												style="padding-left: 44px;">性别： </label>
										</div>
										<select class="custom-select" name="sex" value="${User.age }">
								...
								<div class="row form-group">
									<div class="input-group mb-3">
										<div class="input-group-prepend">
											<label class="input-group-text" for="inputGroupSelect01"
												style="padding-left: 44px;">身高：</label>
										</div>
										<select class="custom-select" name="height" value="${User.height }">
										...
										</select> <span style="padding: 5px;">cm</span>
									</div>
								</div>
								...
								<div class="row form-group">
									<div class="input-group mb-3">
										<div class="input-group-prepend">
											...
											<select id="s_province" class="custom-select"name="s_province" value="${User.s_province }"></select> 
											<select id="s_city" class="custom-select" name="s_city" value="${User.s_city }"></select> 
											<select id="s_county" class="custom-select" name="s_county" value="${User.s_county }"></select>
											<script class="resources library" type="text/javascript">
													...
													*/
													...
													var opt0 = ["${User.s_province }","${User.s_city }","${User.s_county }"];//初始值
								...
								<div class="row form-group">
									<div class="input-group mb-3">
										<div class="input-group-prepend">
											<label class="input-group-text" for="inputGroupSelect01"
												style="padding-left: 28px;">月收入：</label>
										</div>
										<select class="custom-select" name="salary" value="${User.salary }">
											<option selected>${User.salary }</option>
								...
								<div class="row form-group">
									<div class="input-group mb-3">
										...
										<select class="custom-select" name="marital" value="${User.marital }">
											<option selected>${User.marital }</option>
								...
								<div class="row form-group">
									<div class="input-group mb-3">
										<div class="input-group-prepend">
											<label class="input-group-text" for="inputGroupSelect01"
												style="padding-left: 44px;">学历：</label>
										</div>
										<select class="custom-select" name="education" value="${User.education }">
											<option selected>${User.education }</option>
											<option value="不限">不限</option>
								...
								<div class="row form-group">
									<div class="input-group mb-3">
										<div class="input-group-prepend">
											<label class="input-group-text" for="inputGroupSelect01">住房条件：</label>
										</div>
										<select class="custom-select" name="house" value="${User.house }">
											<option selected>${User.house }</option>
								...
								<div class="row form-group">
									<div class="input-group mb-3">
										...
										<select class="custom-select" name="children" value="${User.children }">
											<option selected>${User.children }</option>
								...
								<div id="baseInfoButton">
									...
									<a href="${pageContext.request.contextPath }/TOsingle" id="baseInfoButtonA2" class="btn btn-outline-danger" role="button" aria-disabled="true">跳过</a>
								</div>
